pipeline {
    ...
    IMAGE_REPO="public.ecr.aws/t7w6k2i1/mindtree:latest"
    }
    stages {
        stage('Checkout Code') {
            steps {
                echo "Checking out source code"
                git 'https://github.com/SAM283-bot/Samarth-DevOps-Project'
        ...
        stage('Build & Push Docker Image') {
            ...
            steps {
                sh '''
                    ...
                    aws ecr-public get-login-password --region us-east-1 | docker login --username AWS --password-stdin public.ecr.aws/t7w6k2i1
